window.addEventListener('DOMContentLoaded', () => {
	...
	const sendForm = () => {
		...
		const body = document.querySelector('body'),
			...
			loadingDiv = document.createElement('div'); // cоздаем новый DIV для элемента загрузки
		// 	loadingStyle = document.createElement('style'); // создаем тег для новых стилей для элемента загрузки
		...
		`; // Мне показалось компактнее стили указать прям в теге изображения
